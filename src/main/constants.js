...
export default {
    ...
    CAPABILITIES_TYPE: {
        ...
        PHONEBOOK: 'PHONEBOOK',
        HAS_EXTERNAL_SPEAKER: 'HAS_EXTERNAL_SPEAKER',
        CAN_SET_EXTERNAL_SPEAKER: 'CAN_SET_EXTERNAL_SPEAKER',
        HAS_EXTERNAL_MICROPHONE: 'HAS_EXTERNAL_MICROPHONE',
        CAN_SET_EXTERNAL_MICROPHONE: 'CAN_SET_EXTERNAL_MICROPHONE'
    },
    CALL_STATE: {
        RINGING: 'ringing',
        CONNECTED: 'connected',
