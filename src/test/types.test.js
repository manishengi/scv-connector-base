...
describe('Types validation tests', () => {
    ...
    const dummyCallInfo = new CallInfo({ isOnHold: false, showMuteButton: true, showAddBlindTransferButton: true, showRecordButton: true, showAddCallerButton: true, showMergeButton: true, showSwapButton: true, callAttributes: "\"SourceType\": \"Service\"" });
