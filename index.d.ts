declare module 'scv-connector-base/main/baseConnector' {
  /**
  ...
  import { VendorConnector } from "scv-connector-base/main/types.js/index";

}
declare module 'scv-connector-base/main/constants' {
  namespace _default {
...
declare module 'scv-connector-base/main/downloadData' {
  /**
   ...
   */
  export function downloadData(data: object, fileName: string, fileType: string): void;

}
declare module 'scv-connector-base/main/index' {
  export { log } from "scv-connector-base/main/logger.js/index";
  export { initializeConnector, publishEvent, publishError, publishLog } from "scv-connector-base/main/baseConnector.js/index";
  export { Constants, ActiveCallsResult, AgentConfigResult, AgentConfig, SharedCapabilitiesResult, VoiceCapabilitiesResult, RecordingToggleResult, ParticipantResult, SignedRecordingUrlResult, ContactsResult, PhoneContactsResult, CallResult, HangupResult, HoldToggleResult, InitResult, GenericResult, MuteToggleResult, LogoutResult, CallInfo, PhoneCall, PhoneCallAttributes, Contact, Phone, AgentStatusInfo, AudioStatsElement, AudioStats, StatsInfo, VendorConnector, TelephonyConnector, SuperviseCallResult, SupervisorHangupResult, SupervisedCallInfo, AgentVendorStatusInfo, StateChangeResult, CustomError, AgentWork, ShowStorageAccessResult, DialOptions, ContactsFilter, AudioDevicesResult, ACWInfo, SetAgentConfigResult, HidDevice } from "scv-connector-base/main/types.js/index";

}
declare module 'scv-connector-base/main/logger' {
  /**
...
declare module 'scv-connector-base/main/mosUtil' {
  export function enableMos(): void;
  export function getMOS(): number;
  export function initAudioStats(): void;
  export function updateAudioStats(statsArray: any): void;

}
declare module 'scv-connector-base/main/types' {
  ...
  */
  export class VendorConnector {
       ...
       *
       */
      setAgentStatus(agentStatus: any, statusInfo: any, enqueueNextState: boolean): Promise<GenericResult>;
      /**
       * Get agent status
...
declare module 'scv-connector-base/test/baseConnector.test' {
  export {};

}
declare module 'scv-connector-base/test/logger.test' {
  export {};

}
declare module 'scv-connector-base/test/types.test' {
  export {};

}
declare module 'scv-connector-base' {
  import main = require('scv-connector-base/index');
  export = main;
}